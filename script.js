...
const levelMaster = [
    ...
    { 
        ...
        unit: "正負の数", 
        title: "累乗", 
        hint: "<b>【累乗と計算の順序】</b><br>1.累乗 → 2.カッコ → 3.乗除 → 4.加減 の順で計算します。<br>特に累乗のカッコの有無には注意！<br>$(-3)^2 = (-3) \times (-3) = 9$ ですが、<br>$-3^2 = -(3 \times 3) = -9$ となり、結果が変わります。<br>どこが2乗されているのかをしっかり見極めよう。" 
    },
    { 
        lv: 4, 
        unit: "文字の式", 
        title: "表し方", 
        hint: "<b>【文字式のルール】</b><br>① $\\times$ や $\\div$ の記号は省く！<br>② 数字は文字の前に書く！<br>③ 文字はアルファベット順に並べる！<br>例：$a \times b \times 3 = 3ab$<br>例：$x \\div 5 = \\frac{x}{5}$<br>※$1x$ の『1』は省略して $x$ と書くルールも忘れずに。" 
    },
    { 
        lv: 5, 
        unit: "文字の式", 
